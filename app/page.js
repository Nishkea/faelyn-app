...
export default function Home() {
  return (
    <div className='w-screen h-screen flex flex-wrap gap-4 p-5'>
      ...
      <Card link='/casino' title='Casino royale' description='Try your luck' image='https://directus.shoto.studio/assets/65f8dd74-0e7d-47a0-bbc2-9d661dd8d77c.webp' />
...
function Card({ link, title, description, image = undefined }) {
  ...
  return (
    <div onClick={() => router.push(link)} className='w-[49%] h-[49%] cursor-pointer flex items-center justify-center rounded-xl bg-gradient-to-tr from-black to-slate-800 text-white hover:scale-[1.025] duration-200 overflow-hidden relative'>
